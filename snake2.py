...
def play_game(snake_head, snake_position, apple_position, button_direction, apple, edi, score):
    ...
    while crashed is not True:
        ...
        display_snake(snake_position,edi)
...
###### initialize required parameters ########  
    ...
    apple_image = pygame.image.load('edi.jpg')
    edi_image = pygame.image.load('edi.jpg')
    ...
    final_score = play_game(snake_head, snake_position, apple_position, 1, apple_image, edi_image, score)
    display = pygame.display.set_mode((display_width,display_height))
    display.fill(window_color)
    pygame.display.update()
